...
It is a high performance,  brokered messaging queue which supports transient and durable queues.  Durable queue are similar to Kafka model where data are written to the file and consumers consumes from the file.
